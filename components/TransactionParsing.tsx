      ...
      >
        ...
        >
          <div className="flex items-center justify-around gap-4 w-full">
            ...
            {/* Parsing Button (current page - highlighted) */}
            <button
              onClick={onBack}
              className="p-3 rounded-full transition-all duration-300 text-emerald-600 dark:text-emerald-400 active:scale-95"
              aria-label="Close transaction parsing"
            >
              <svg
                className="w-6 h-6"
                viewBox="0 0 24 24"
