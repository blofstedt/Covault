                ...
                {autoDetectedTransactions.length > 0 ? (
                  <div className="space-y-2">
                    {autoDetectedTransactions.map((tx) => (
                      <div
                        key={tx.id}
                        className="w-full flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800/60 transition-all"
                      >
                        <button
                          onClick={() => onTransactionTap?.(tx)}
                          className="flex items-center space-x-3 flex-1 min-w-0 active:scale-[0.98] transition-all"
                        >
                            ...
                            confirmDeleteId === tx.id ? (
                              <div className="flex items-center space-x-1">
                                <button
                                  ...
                                  className="p-1.5 rounded-xl bg-rose-500 text-white active:scale-95 transition-all"
                                ...
                                <button
                                  ...
                                  className="p-1.5 rounded-xl bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-400 active:scale-95 transition-all"
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 hover:bg-rose-50 hover:text-rose-500 dark:hover:bg-rose-900/20 dark:hover:text-rose-400 active:scale-95 transition-all"
