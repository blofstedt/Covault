      ...
      <div className="relative flex-1 flex flex-col items-center justify-center space-y-12">
        <div className="flex flex-col items-center space-y-6 animate-nest">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-5xl font-extrabold text-slate-500 dark:text-slate-100 tracking-tighter">
              Covault
            </h1>
      ...
      <div className="relative space-y-6 mt-auto flex flex-col items-center pb-8">
        ...
        {isLoggingIn ? (
          <div className="flex items-center space-x-4 py-4 animate-pulse">
            ...
            <span className="text-xl font-bold text-slate-500 dark:text-slate-200 tracking-tight">
              Opening Vault...
            </span>
          </div>
        ) : (
          ...
          >
            ...
            <span className="text-slate-600 dark:text-slate-100 font-semibold text-sm tracking-wide">
              Connect with Google
            </span>
          </button>
        )}
