    ...
    >
      ...
      >
        <div className="flex items-center justify-around gap-4 w-full">
          ...
          >
            {pendingCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] flex items-center justify-center px-1 text-[9px] font-black bg-amber-500 text-white rounded-full shadow-lg">
