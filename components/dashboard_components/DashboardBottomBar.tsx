...
const DashboardBottomBar: React.FC<DashboardBottomBarProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`w-auto max-w-xs backdrop-blur-3xl border rounded-full px-3 py-1.5 pointer-events-auto shadow-2xl ring-1 ring-inset ring-white/10 dark:ring-white/[0.04] transition-all duration-700 bg-white/90 dark:bg-slate-900/90 border-slate-100 dark:border-slate-800/60 ${
