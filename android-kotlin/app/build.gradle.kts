...
android {
    namespace = "com.covault.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.covault.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
    ...
    buildTypes {
        release {
            ...
            // Release requires real secrets to be set in local.properties or CI.
        }
        debug {
...
dependencies {
    ...
    // Ktor client engine + serialization - required by supabase-kt
